...
import { createId, formatDate, formatMoney, totalMerchRevenue, type Concert, type MerchSale, type MoneyMovement, type MoneyMovementKind } from './model'
...
export default function Treasury({ concerts }: { concerts: Concert[] }) {
  ...
  const totalIncome = income + merchTotal
