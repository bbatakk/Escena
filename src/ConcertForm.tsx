        ...
        <div className="form-grid">
          ...
          <section className="form-card">
            ...
            <div className="fields">
              ...
              <label className="field">Gestionat per <select value={d.management || 'pendent'} onChange={(e) => setManagement(e.target.value as 'pendent' | 'banda' | 'discografica')}><option value="pendent">Per concretar</option><option value="banda">La banda</option><option value="discografica">Segell / discogràfica</option></select></label>
